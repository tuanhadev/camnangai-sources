...
### 3. Reduced need for open source libraries
...
### 4. Post-modern/fragmented software emerges
...
### 5. New bottlenecks for software

If vibe coding makes software trivial to build, then the bottlenecks shift to other places:

- **Consistent creativity** that stays ahead of everyone else. Anyone can write a tweet, but the best creators are the ones who consistently come up with new ideas.
- **Distribution and network effects**, where the first vibe coded product doesn't win, but rather the first vibe coded product that hits scale that wins.

### 6. Adaptive software specified by outcomes
...
### 7. Acceleration of software eating long tail industries
...
### 8. Software development teams will change
...
### 9. Vibe marketing and vibe selling
...
For those who are ready to explore, it's not hard. The tools are actually pretty easy to play around with and set up. I recommend Replit Agent if you want to get going quickly with a demo, but most people seem to be using Cursor.

### Fundamentals for building vibe coded projects:
...
- Ask Cursor "is it clear? what are your questions" => usually ask 9-10 questions. You answer and ask him to add to the impl file
...
- **Project bigger than 20k LOC?** Ask Sonnet to create an architecture.md. This file will help all future prompts

The author notes: "I am at 3000+ prompts in Cursor. I really feel like I am a whisperer. I jump from Sonnet 3.5 to 4o and now to 4.5 depending on nuances I know those models have. For instance, 'improve my messaging' => 4.5"

---

*By Andrew Chen*  
*A reader-supported publication focused on venture capital in tech, entertainment, and AI*
